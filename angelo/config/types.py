...
from ..const import ANGELOFILE_V1_0 as V1
from ..utils import unquote_path
from .errors import ConfigurationError
from angelo.const import IS_WINDOWS_PLATFORM
from angelo.utils import splitdrive
...
def normpath(path, win_host=False):
    """ Custom path normalizer that handles Angelo-specific edge cases like
